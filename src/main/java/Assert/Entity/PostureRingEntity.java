...
public class PostureRingEntity extends SpawnEntity<TextDisplay> {
    private static final char base = 0xea1c;

    public PostureRingEntity(Location location, int status) {
